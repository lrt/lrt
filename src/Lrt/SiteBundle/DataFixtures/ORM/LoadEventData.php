...
class LoadEventData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->newEvent('Régionaux route', new \DateTime('2013-04-27'), new \DateTime('2013-04-28'), 'Breuillet', 'http://www.monsite.fr', 'Test');
        ...
        $this->newEvent('Challenge IDF Muette', new \DateTime('2013-06-23'), new \DateTime('2013-06-23'), 'La Muette (Paris 16ème)', 'http://www.monsite.fr', 'Test');
        $this->newEvent('CFRM', new \DateTime('2013-09-15'), new \DateTime('2013-09-15'), 'Pontarlier', 'http://www.monsite.fr', 'Test');
