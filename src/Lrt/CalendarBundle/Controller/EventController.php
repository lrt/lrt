...
namespace Lrt\CalendarBundle\Controller;
...
use Lrt\CalendarBundle\Entity\Event;
use Lrt\CalendarBundle\Form\EventType;
...
class EventController extends Controller
{
    ...
    {
        $events = $this->em->getRepository('CalendarBundle:Event')->findAll();
     ...
     * @ParamConverter("event", class="CalendarBundle:Event", options={"id" = "id"})
     * @Template()
     */
     ...
     * @Method("POST")
     * @Template("CalendarBundle:Event:new.html.twig")
     */
     ...
     * @ParamConverter("event", class="CalendarBundle:Event", options={"id" = "id"})
     * @Method("POST")
     * @Template("CalendarBundle:Event:edit.html.twig")
     */
